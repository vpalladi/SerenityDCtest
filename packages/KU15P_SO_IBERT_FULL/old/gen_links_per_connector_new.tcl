...
set groupName [list "Tx0 -> Rx0" "Tx1 -> Rx1" "Tx2 -> Rx2" "Tx3 -> Rx3" "Tx4 -> Rx4" "Tx5 -> Rx5"]

foreach txList $txAll rxList $rxAll gName $groupName {
    ...
    foreach tx $txList rx $rxList {
        ...
        set xil_newLink 
        create_hw_sio_link -description "Link $i " [lindex [get_hw_sio_txs "$pathBaseGTH/Quad_234/MGT_X0Y41/TX"] 0] [lindex [get_hw_sio_rxs "$pathBaseGTH/Quad_232/MGT_X0Y32/RX"] 0]
#        lappend xil_newLinks $xil_newLink
    ...
    #set xil_newLinkGroup [create_hw_sio_linkgroup -description $gName [get_hw_sio_links $xil_newLinks]]
